...
uint256 hashGenesisBlock("0x9fdedc79025c440cdf55165a132793fb6242c0f7932baedfafbaa1afdff39e6d");
...
const string strMessageMagic = "prvicoin Signed Message:\n";
...
{
    int64 nSubsidy = 113131313131313131313131313 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // prvicoin: 1 days
static const int64 nTargetSpacing = 22; // prvicoin: 22 sekund blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal prvicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "prvicoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7460c9553f6f299b557e8131560f6b47b1dcd07b07bb1e0eca2617d69854f6c8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1404305157; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1404305157;
            block.nNonce   = 316337;
        }
...
string GetWarnings(string strFor)
{
    ...
    {
        nPriority = 2000;
        strStatusPrv = strRPC = "WARNING: Displayed transactions may not be correct!  You may need to upgrade, or other nodes may need to upgrade.";
    }
    ...
    // Alerts
    {
        ...
        BOOST_FOREACH(PAIRTYPE(const uint256, CAlert)& item, mapAlerts)
        {
            ...
            if (alert.AppliesToMe() && alert.nPriority > nPriority)
            {
                ...
                strStatusPrv = alert.strStatusPrv;
            }
        }
    }
