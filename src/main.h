...
static const int64 MAX_MONEY = 5000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 3888 / 250; // 3888 blocks found a day. Priority cutoff is 1 PRV day / 250 bytes.
    }
 ...
 * need to upgrade.  The message is displayed in the status prv.
