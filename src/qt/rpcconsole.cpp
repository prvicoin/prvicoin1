...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the prvicoin RPC console.") + "<br>" +
...
{
    QScrollPrv *scrollprv = ui->messagesWidget->verticalScrollPrv();
    scrollprv->setValue(scrollprv->maximum());
}
